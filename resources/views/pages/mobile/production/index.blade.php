  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Material Production</h3>
      ...
      <div class="card-body">
        ...
        <table class="w-100">
          ...
          @else
          <div class="d-flex justify-content-center mt-2">      
            <button class="btn btn-secondary btn-sm btn-primary" data-toggle="modal" data-target="#modalPengajuan">
          ...
          <div class="modal fade" id="modalPengajuan">
            <div class="modal-dialog modal-md modal-dialog-centered">
              <div class="modal-content">
                <form action="{{ route('m.production.ajukan',$item->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="modal-header">
                    <h4 class="modal-title">Ajukan Material Production</h4>
